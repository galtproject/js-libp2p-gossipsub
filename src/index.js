...
class Gossipsub extends pubsub_1.default {
     ...
     * @param {SignaturePolicy} [options.globalSignaturePolicy] default signature policy. defaults to 'StrictSign'
    ...
    constructor(libp2p, options = {}) {
        ...
        const opts = Object.assign(Object.assign({ gossipIncoming: true, fallbackToFloodsub: true, floodPublish: true, doPX: false, directPeers: [], D: constants.GossipsubD, Dlo: constants.GossipsubDlo, Dhi: constants.GossipsubDhi, Dscore: constants.GossipsubDscore, Dout: constants.GossipsubDout, Dlazy: constants.GossipsubDlazy, globalSignaturePolicy: 'StrictSign' }, options), { scoreParams: score_1.createPeerScoreParams(options.scoreParams), scoreThresholds: score_1.createPeerScoreThresholds(options.scoreThresholds) });
